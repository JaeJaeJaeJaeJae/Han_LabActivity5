package com.jaeyeon.han_labactivity5;
...
public class MainActivity extends AppCompatActivity implements AdapterView.OnItemClickListener {
    ...
    int[] logos = {R.drawable.picone, R.drawable.pictwo, R.drawable.picthree, R.drawable.picfour, R.drawable.picfive,
            R.drawable.picsix, R.drawable.picseven, R.drawable.piceight, R.drawable.picnine, R.drawable.picten,
            R.drawable.piceleven, R.drawable.pictwelve, R.drawable.picthirteen, R.drawable.picfourteen};
